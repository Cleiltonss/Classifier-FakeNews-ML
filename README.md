      ...
      >
        <title id="titleId">Cleilton Sousa's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2025 : 51, Total PRs: 8, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 239.20831373720648;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Cleilton Sousa's GitHub Stats</text>
    </g>
      </g>
